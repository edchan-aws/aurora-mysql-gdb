...
1. First let us login to the Apache Superset interface again via the Secondary Region instance URL.
...
1. You should notice both your previous results and the new record. Your application is now serving both read and write queries and serve your users as normal, during a region level disruption!
